  ...
  return (
    <MainLayout>
      ...
      <nav className="flex items-center gap-2 text-sm mb-6">
        ...
        <span className="text-emerald-500 font-medium">Add Category</span>
      </nav>

      {/* PAGE TITLE */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-white mb-2">Add Category</h1>
        <p className="text-gray-400 text-sm">Tambahkan kategori baru untuk transaksimu.</p>
      </div>
